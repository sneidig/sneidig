...
C# / .NET developer with 10+ years building backend services, REST APIs, and
e-commerce systems. Certified nopCommerce developer. I build with AI in my daily
workflow and review everything it produces before it ships.

**Tech I work with**
C#, ASP.NET Core, Web API, Entity Framework Core, SQL Server, Azure, and AI tooling
